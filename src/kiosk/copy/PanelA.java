...
public class PanelA extends JPanel{
   ...
   JButton aBt=new JButton("김치찌개",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
   JButton bBt=new JButton("된장찌개",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
   JButton cBt=new JButton("순두부찌개",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
   JButton dBt=new JButton("동태찌개",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
   JButton eBt=new JButton("비지찌개",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
   JButton fBt=new JButton("부대찌개",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
