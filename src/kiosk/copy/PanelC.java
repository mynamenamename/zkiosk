...
public class PanelC extends JPanel{
	...
	//직접 객체 생성
	JButton btn1 = new JButton("초밥",new ImageIcon("src\\kiosk\\imgs\\sushi2.PNG"));
	JButton btn2 = new JButton("돈까스",new ImageIcon("src\\kiosk\\imgs\\don.PNG") );
	JButton btn3 = new JButton("카레", new ImageIcon("src\\kiosk\\imgs\\care.PNG"));
	JButton btn4 = new JButton("우동",new ImageIcon("src\\kiosk\\imgs\\udon.PNG"));
	JButton btn5 = new JButton("텐동", new ImageIcon("src\\kiosk\\imgs\\tendong.PNG"));
	JButton btn6 = new JButton("라멘",new ImageIcon("src\\kiosk\\imgs\\ramen.PNG"));
